...
class TextGenerator:
    def __init__(self, 
                 checkpoint='./pretrain_1024_16_6144.pth',  # 模型检查点路径
                 tokenizer_model_path='./tokenizer_bpe/',  # 分词器模型路径
                 seed=42,  # 随机种子，确保可重复性
        ...
        self.device = device or ('cuda:3' if torch.cuda.is_available() else 'cpu')  # 根据硬件条件选择设备
...
if __name__ == "__main__":
    ...
    generator = TextGenerator(checkpoint='./sft_dim1024_layers16_vocab_size6144.pth')  # 初始化生成器
